def exchanges(moneda,cantidad):
    ...
    if moneda == 1:
        ...
        print(f'Los {cantidad} pesos chilenos equivalen a {result:.2f} dolares')
    # Moneda colombiana
    elif moneda == 2:
        result = cantidad * 0.00027
        print(f'Los {cantidad} pesos colombianos equivalen a {result:.2f} dolares')
    # Moneda Argentina
    elif moneda == 3:
        result = cantidad * 0.014
        print(f'Los {cantidad} pesos argentinos equivalen a {result:.2f} dolares')
    # Moneda mexicana
    elif moneda == 4:
        result = cantidad * 0.044
        print(f'Los {cantidad} pesos mexicanos equivalen a {result:.2f} dolares')
    # Otro
    else:
